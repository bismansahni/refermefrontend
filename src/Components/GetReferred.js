...
// import 'react-toastify/dist/ReactToastify.css';
// import { useProfile } from '../Context/ProfileContext';
// import styles from '../styles/GetReferred.module.css'; // Import CSS Module
// import popupStyles from '../styles/Popup.module.css'; // Import Popup CSS Module
...
//   return (
//     <div className={`${styles.mainRegisterContainer} ${animation}`}>
//       <ToastContainer style={{ zIndex: 10000 }} />
//       {showOverlay && <div className={styles.overlay}></div>}
//       {showForm && (
//         <>
//           <div className={styles.mainRegisterContainerImage} onClick={handleDivClick}>
//           </div>
//           <div className={styles.registerBox}>
//             <div className={styles.registerBoxLeft}></div>
//             <div className={`${styles.registerBoxRight} ${!isEditable ? styles.ineditable : ''}`}>
...
//                       required
//                       disabled={!isEditable} // Disable input if form is not editable
//                       className={!isEditable ? styles.ineditable : ''} // Apply ineditable class if not editable
//                     />
//                   </div>
//                   <div className={styles.formGroup}>
//                     <label htmlFor="job_url">Job URL</label>
...
//             <p><strong>Resume:</strong> {profileData.resume}</p>
//           </div>
//           <div className={popupStyles.popupBoxBottom}>
//             <button onClick={handleConfirmProfile}>Confirm Profile Details</button>
//             <button onClick={handleUpdateProfile}>Update Profile</button>
//             <button onClick={handleClosePopup}>Close</button>
//           </div>
